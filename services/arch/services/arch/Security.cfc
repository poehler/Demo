<cfcomponent output="false">
    ...
    --->
    <cffunction name="validateSession" access="public" returntype="any" hint="returns a user object if correct credentials turned in" output="false">
        ...
        <cftry>
            ...
            <cfif s_sessions.recordCount gt 0>
                <cfset user.user_id = s_sessions.user_id>
                <cfset user.type = s_sessions.type>
            </cfif>
